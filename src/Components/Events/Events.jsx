...
const Events = () => {
  return (
    <div>
        ...
        <div className="event-box flex flex-wrap gap-28  justify-center items-center">
          ...
          <div className="event-card w-[300px] h-[290px] bg-white rounded-lg shadow-lg flex flex-col justify-center items-center">
            <div className="event-image w-[150px] h-[150px] bg-gray-300 rounded-full flex justify-center items-center">
