    ...
    return (
        <div>
            <div className="venue-location mt-24 px-4 sm:px-6">
                <div className="heading text-white text-center text-3xl sm:text-4xl font-bold font-main tracking-wider mb-12 sm:mb-16" id='venue'>Venue</div>
                ...
                <div className="contant-locations w-full sm:w-[90%] mx-auto flex flex-col sm:flex-row gap-6 sm:gap-10 justify-center items-center">
                    <div className="venue-info text-white flex flex-col gap-4 sm:gap-5 w-full sm:w-[50%] p-6 sm:p-10 mb-5 font-base">
