  ...
  return (
    <div>
      <div className="header relative w-full  h-[800px] flex justify-center items-center" id="home">
        <video autoPlay muted loop preload="metadata" className="w-full h-full object-cover" >  <source src="https://res.cloudinary.com/dgrkxzvn1/video/upload/v1741446208/5453622-uhd_3840_2160_24fps_izpv0v.mp4" type="video/mp4" />
        </video>
