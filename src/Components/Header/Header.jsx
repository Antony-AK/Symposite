  ...
  return (
    <div>
      <div className="header relative w-full h-[700px] flex justify-center items-center" id="home">
        ...
        <div className="sympologo absolute w-48 h-48 md:w-72 md:h-72 z-20 rounded-full -mt-[20rem] md:-mt-[19rem]" data-aos="zoom-in" data-aos-duration="1000">
          <img src={sympologo1} alt="" className="rounded-full w-full h-full" />
        </div>

        <div className="title absolute z-20 text-center -mt-[7rem] md:mt-[2rem] text-yellow-400 font-bold font-logo" data-aos="zoom-in" data-aos-duration="1200">
          <h1 className="text-2xl md:text-3xl">TECH OLYMPICS’25</h1>
        </div>

        <div className="event-details absolute z-20 text-center mt-[4rem] md:mt-[12rem] px-4" data-aos="zoom-in" data-aos-duration="1400">
