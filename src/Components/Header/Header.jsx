...
const Header = () => {
  return (
    <div>
      <div className="header relative w-full h-[750px] flex justify-center items-center" id="home">
        <video autoPlay muted loop src={v1} className="w-full h-full object-cover" data-aos="zoom-up-out" data-aos-duration="500"></video>

        <div className="sympologo absolute w-48 h-48 md:w-72 md:h-72 z-20 rounded-full -mt-[24rem] md:-mt-[21rem]" data-aos="zoom-in" data-aos-duration="1000">
          <img src={sympologo1} alt="" className="rounded-full w-full h-full" />
        </div>

        <div className="title absolute z-20 text-center -mt-[11rem] md:-mt-[2rem] text-yellow-400 font-bold font-logo" data-aos="zoom-in" data-aos-duration="1200">
          <h1 className="text-2xl md:text-3xl">TECH OLYMPICS’25</h1>
        </div>

        <div className="event-details absolute z-20 text-center -mt-[1rem] md:mt-[8rem] px-4" data-aos="zoom-in" data-aos-duration="1400">
        ...
        <div className="group-button absolute mt-[440px] sm:hidden">
